function bindBaseElements() {
  var ids = [
    ...
    "settingsStrictCase", "settingsUndo", "excludedInput", "excludedAddBtn",
    "excludedList", "settingsSaveBtn", "settingsCloseBtn",
    "autoUpdateToggle", "autoUpdateStatus", "alicFontToggle", "alicHoverToggle", "alicHoverDelaySlider", "alicHoverDelayLabel",
