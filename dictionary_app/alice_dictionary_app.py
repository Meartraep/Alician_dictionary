...
class AliceDictionaryApp:
    def __init__(self, root: tk.Tk, search_word=None, exact_match=False):
        self.root = root
        self.current_word = ""
        ...
        if search_word:
            ...
            self.ui.query_entry.insert(0, search_word)
            
            # 设置精确查找状态
            self.ui.exact_match_var.set(exact_match)
            
            # 自动执行搜索
            self.root.after(100, self.search_word)
