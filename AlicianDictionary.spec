...
a = Analysis(
    ...
    datas=[
        ...
        ('alice_app.ico', '.'),
        ('alice.ico', '.'),
        # Model weights are installed as a persistent external component.
        # Keep the pinned model manifest inside the program for diagnostics.
        ('installer/model_manifest.json', 'text2vec_model'),
    ],
